...
<details>
<summary>Browse 39 files</summary>
...
- [app/web/src/components/chat/activity-indicator.tsx](app/web/src/components/chat/activity-indicator.tsx)
- [app/web/src/components/chat/chat-view.tsx](app/web/src/components/chat/chat-view.tsx)
- [app/web/src/components/chat/chat.module.css](app/web/src/components/chat/chat.module.css)
- [app/web/src/components/chat/composer.tsx](app/web/src/components/chat/composer.tsx)
- [app/web/src/components/chat/message-list.tsx](app/web/src/components/chat/message-list.tsx)
- [app/web/src/components/chat/message.tsx](app/web/src/components/chat/message.tsx)
- [app/web/src/components/chat/review-gate.tsx](app/web/src/components/chat/review-gate.tsx)
- [app/web/src/components/history/content-drawer.tsx](app/web/src/components/history/content-drawer.tsx)
- [app/web/src/components/history/fixed-intent-summary.tsx](app/web/src/components/history/fixed-intent-summary.tsx)
- [app/web/src/components/history/history-menu.tsx](app/web/src/components/history/history-menu.tsx)
- [app/web/src/components/history/history-record.tsx](app/web/src/components/history/history-record.tsx)
- [app/web/src/components/history/history-review.tsx](app/web/src/components/history/history-review.tsx)
- [app/web/src/components/history/history.module.css](app/web/src/components/history/history.module.css)
- [app/web/src/components/integration/integration-dialog.tsx](app/web/src/components/integration/integration-dialog.tsx)
- [app/web/src/components/integration/integration-form.tsx](app/web/src/components/integration/integration-form.tsx)
- [app/web/src/components/integration/integration-list.tsx](app/web/src/components/integration/integration-list.tsx)
- [app/web/src/components/integration/integration.module.css](app/web/src/components/integration/integration.module.css)
- [app/web/src/components/shell/shell.module.css](app/web/src/components/shell/shell.module.css)
- [app/web/src/components/shell/sidebar.tsx](app/web/src/components/shell/sidebar.tsx)
- [app/web/src/components/shell/web-shell.tsx](app/web/src/components/shell/web-shell.tsx)
- [app/web/src/hooks/use-conversation.ts](app/web/src/hooks/use-conversation.ts)
- [app/web/src/hooks/use-history.ts](app/web/src/hooks/use-history.ts)
- [app/web/src/hooks/use-integrations.ts](app/web/src/hooks/use-integrations.ts)
- [app/web/src/hooks/use-run.ts](app/web/src/hooks/use-run.ts)
- [app/web/src/lib/api.ts](app/web/src/lib/api.ts)
- [app/web/src/lib/contracts.ts](app/web/src/lib/contracts.ts)
- [app/web/src/lib/event-stream.ts](app/web/src/lib/event-stream.ts)
- [app/web/src/lib/http-client.ts](app/web/src/lib/http-client.ts)
- [app/web/src/lib/projections.ts](app/web/src/lib/projections.ts)
- [app/web/src/pages/_app.tsx](app/web/src/pages/_app.tsx)
- [app/web/src/pages/index.tsx](app/web/src/pages/index.tsx)
- [app/web/src/styles/globals.css](app/web/src/styles/globals.css)
- [app/web/src/types.d.ts](app/web/src/types.d.ts)
...
- [scripts/e2e/browser/rebuild-e2e.mjs](scripts/e2e/browser/rebuild-e2e.mjs)
...
- [scripts/e2e/browser/verify-full-pipeline-workflow.mjs](scripts/e2e/browser/verify-full-pipeline-workflow.mjs)
