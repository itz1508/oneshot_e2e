...
The tool registry is a narrow dispatch surface. Deterministic implementations live in `validation/` and wrapper scripts live under this Skill's `scripts/` folder.
