...
function load(relative) {
    ...
    const localRequire = name => name === '../lib/projections' ? load('../src/lib/projections.ts') : require(name);
    new Function('require', 'module', 'exports', outputText)(localRequire, module, module.exports);
    return module.exports;
}
const { BuildCard, ResultCard, MutationsTable } = load('../src/components/review-cards.tsx');
