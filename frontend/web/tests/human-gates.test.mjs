...
import { buildReviewHTML, researchSummaryHTML, hasVerifiedHash, createHumanGates, collectEdits } from '../src/console/human-gates.js';
import { jobSnapshotHTML } from '../src/console/job-history.js';
