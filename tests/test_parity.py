...
class TestParity(unittest.TestCase):
 def test_researcher_valid_and_unknown_field(self):
  s=SchemaStore(ROOT/'schema'); b=json.loads((ROOT/'app/fixtures/e2e/complete-success.json').read_text())['researcher']; c='urn:oneshot:schema:researcher:1'
 ...
 def test_strict_type_rejection(self):
  s=SchemaStore(ROOT/'schema'); b=json.loads((ROOT/'app/fixtures/e2e/complete-success.json').read_text())['plan']; c='urn:oneshot:schema:plan:1'; bad=copy.deepcopy(b); bad['revision']='2'
