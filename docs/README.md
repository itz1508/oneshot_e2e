...
Provider implementation now lives in [`app/web/cloud`](../app/web/cloud/README.md) — the source map for the manager, resolver, catalog, adapters, credential stores and Python workers.
