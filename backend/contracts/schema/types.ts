...
export type ProcessingScope = "WORKFLOW" | "SUPPORT" | "SANDBOX";
...
export interface ResearchBundle { prompt_id?: string; prompt: Prompt; researcher: ResearcherArtifact; plan: Plan; schema_artifact: SchemaArtifact; fixture: Fixture; goal: Goal; validation: ValidationDefinition; }
...
export interface RunSnapshot { run_id:string; pipeline_status:PipelineStatus; test_result?:TestResult; issue_type?:IssueType; current_processor?:string; events:ProcessingEvent[]; artifacts:Record<string,string>; hash_proof?:HashProof; root_cause?:RootCause;     help_request?:import("../../intent/types.js").HelpRequest; route_snapshot?:Record<string,unknown> }
