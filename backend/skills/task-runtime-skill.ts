 ...
 *
 * Tools: project_run, audit_run, project_workflow_graph, project_authority_graph
 *
    ...
    this.registry.register(
      {
        ...
        description: "Read OneShot workflow graph projection",
      },
      ({ run_id }: { run_id: string }) =>
        projectWorkflowGraph(this.task.events.list(run_id)),
    );
