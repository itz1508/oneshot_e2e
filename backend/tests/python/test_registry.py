...
class TestRegistry(unittest.TestCase):
 ...
 def test_committed_registry_matches_checkout_bytes(self):
  stored=json.loads((ROOT/'backend/schema/contract-registry.json').read_text(encoding='utf-8'))
  self.assertEqual(build_registry(ROOT/'backend/schema'),stored)
