...
export interface ProcessingEvent { event_id:string; sequence:number; run_id:string; scope:ProcessingScope; processor:string; state:ProcessingState; result?:WorkflowResult|ValidationResult; artifact_id?:string; message?:string; created_at:string; causation_id?:string; correlation_id:string; traceparent:string }
